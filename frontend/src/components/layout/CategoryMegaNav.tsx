...
export const CATEGORIES_DATA: CategoryItem[] = [
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Printed Cotton Sarees', href: '/products?category=women&sub=sarees' },
          { label: 'Designer Kurtha Tops', href: '/products?category=women&sub=tops' },
        ],
      },
      {
        title: 'READY-TO-WEAR & WORKWEAR',
        viewAllHref: '/products?category=women',
        links: [
          { label: 'Workwear Shirts & Tops', href: '/products?category=women&sub=tops' },
          { label: 'Tailored Trousers & Pants', href: '/products?category=women&sub=bottoms' },
          { label: 'All Women’s Wear', href: '/products?category=women' },
        ],
      },
      {
        ...
        viewAllHref: '/products?category=women',
        links: [
          { label: 'Handloom Cotton Fabrics', href: '/products?category=women&sub=sarees' },
          { label: 'Cotton-Rich Cuts', href: '/products?category=women&sub=tops' },
          { label: 'Stretch Poly-Crepe', href: '/products?category=women&sub=bottoms' },
        ],
      },
    ],
    promoCard: {
    ...
    columns: [
      {
        ...
        links: [
          { label: 'Formal Executive Shirts', href: '/products?category=men&sub=shirts' },
          { label: 'Short Sleeve Cotton Shirts', href: '/products?category=men&sub=shirts' },
          { label: 'Resort Printed Casual Shirts', href: '/products?category=men&sub=shirts' },
        ],
      },
      {
        title: 'TROUSERS & BOTTOMS',
        viewAllHref: '/products?category=men&sub=trousers',
        links: [
          { label: 'Ultra Slim Formal Trousers', href: '/products?category=men&sub=trousers' },
          { label: 'Chino Smart Casual Pants', href: '/products?category=men&sub=trousers' },
          { label: 'All Men’s Bottoms', href: '/products?category=men&sub=trousers' },
        ],
      },
    ],
    promoCard: {
      title: 'Men’s Collection',
      subtitle: 'Executive shirts, tailored trousers & comfort chinos',
  ...
  },
  {
    ...
    columns: [
      {
        title: 'TOPS & JACKETS',
        viewAllHref: '/products?category=teenagers',
        links: [
          { label: 'Vintage Denim Jackets', href: '/products?category=teenagers&sub=jackets' },
          { label: 'Graphic T-Shirts & Polos', href: '/products?category=teenagers&sub=t-shirts' },
          { label: 'Wrapped Waist Shirts', href: '/products?category=teenagers&sub=tops' },
        ],
      },
      {
        title: 'BOTTOMS & OUTFITS',
        viewAllHref: '/products?category=teenagers',
        links: [
          { label: 'Side Slit Casual Skirts', href: '/products?category=teenagers&sub=skirts' },
          { label: 'Zipper Utility Jumpsuits', href: '/products?category=teenagers&sub=dresses' },
          { label: 'All Teenagers Wear', href: '/products?category=teenagers' },
        ],
      },
    ],
    promoCard: {
      title: 'Teenagers Trend',
      subtitle: 'Modern streetwear, denim jackets & contemporary youth fashion',
    ...
    columns: [
      {
        ...
        viewAllHref: '/products?category=school-uniforms',
        links: [
          { label: 'All School Uniforms (5 Pleat & Box Pleat)', href: '/products?category=school-uniforms', note: 'Standard approved' },
          { label: 'Boys Regulation Shirts & Shorts', href: '/products?category=school-uniforms', note: 'Durable poplin' },
        ],
      },
      {
        title: 'OFFICE & WORKWEAR',
        viewAllHref: '/products?category=corporate-uniforms',
        links: [
          { label: 'Corporate Office Uniforms (Blazers & Suiting)', href: '/products?category=corporate-uniforms', note: 'Professional attire' },
          { label: 'Workwear & Industrial (Hi-Vis & Safety)', href: '/products?category=industrial-uniforms', note: 'Durable fabrics' },
          { label: 'Healthcare & Hospitality (Doctor Coats & Scrubs)', href: '/products?category=healthcare-uniforms', note: 'Medical grade' },
        ],
      },
    ],
    promoCard: {
